...
(4, 1, 2, DATEADD('DAY', 0, CURRENT_DATE),  '09:00', '09:30', 'confirmed',  '王五', '13800000004', '头晕、胸闷，持续三天，伴有轻微心悸',         NOW()),
(5, 2, 2, DATEADD('DAY', 0, CURRENT_DATE),  '09:30', '10:00', 'pending',    '赵六', '13800000005', '咳嗽、咳痰一周，夜间加重，无发热',           NOW()),
(4, 3, 1, DATEADD('DAY', 0, CURRENT_DATE),  '10:00', '10:30', 'pending',    '王五', '13800000004', '近两周感觉乏力、食欲不振，偶有低热',         NOW()),
(5, 1, 2, DATEADD('DAY', -1, CURRENT_DATE), '14:00', '14:30', 'completed',  '赵六', '13800000005', '高血压复查，近期血压波动较大，伴有头痛',     NOW()),
(4, 5, 5, DATEADD('DAY', 1, CURRENT_DATE),  '08:30', '09:00', 'pending',    '王五', '13800000004', '失眠多梦两周，工作压力大，腰膝酸软',         NOW()),
(5, 1, 2, DATEADD('DAY', 1, CURRENT_DATE),  '10:00', '10:30', 'pending',    '赵六', '13800000005', '反复感冒两周，鼻塞流涕，咽痛',               NOW()),
(4, 4, 3, DATEADD('DAY', 1, CURRENT_DATE),  '08:30', '09:00', 'pending',    '王五', '13800000004', '腰痛一周，弯腰时加重，活动受限',             NOW());
...
CREATE TABLE `health_record` (
    ...
    `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_health_record_user_id` (`user_id`) ,
...
CREATE TABLE `past_disease` (
    ...
    `diagnosis_hospital` VARCHAR(200) DEFAULT NULL,
    `current_status` VARCHAR(20) DEFAULT 'ongoing',
    `treatment` TEXT,
